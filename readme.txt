训练参数: main.py --n_iters=100000 --device=cuda --base_dir=./datasets/images --indices=2,3,4,5,6,10 --batch_size=1 --num_workers=1 --optimizer=Adam --loss=MSE --lr=0.00005 --info_interval=100
